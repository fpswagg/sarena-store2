...
import { FiFacebook, FiTwitter, FiInstagram, FiLinkedin, FiGithub, FiYoutube, FiPhone, FiMail, FiMusic } from 'react-icons/fi'

// TikTok icon component (using music icon as placeholder since react-icons doesn't have TikTok)
